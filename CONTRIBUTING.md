...
Für einen Fehlerbericht hilfreich: Aseprite-Version, Collabsprite-Version, Windows-Version, Modus (Lokal/Radmin), Host oder Gast, genaue Schritte, erwartetes und tatsächliches Verhalten. **Keine Einladungscodes, VPN-Netzwerkkennwörter, privaten IP-/Kontaktangaben, Nutzerbilder oder Dateien aus `data/` posten.** Wenn ein Screenshot einen Code zeigt, verdecke ihn vorher.
